...
namespace EntityFrameWorkWebApi.Models
{
    public class EntityFrameWorkWebApiContext : DbContext
    {
        ...
        public System.Data.Entity.DbSet<EntityFrameWorkWebApi.Models.Movie> Movies { get; set; }

        public System.Data.Entity.DbSet<EntityFrameWorkWebApi.Models.Genre> Genres { get; set; }
    }
}
